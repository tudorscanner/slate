...
| ```pickupPlace``` <br><span class="required">REQUIRED</span> | The pickup location. IATA code or a latitude,longitude pair formatted like this: lat,lon-latlong e.g. /55.95,-3.37-latlong/ |
| ```dropoffPlace``` <br><span class="required">REQUIRED</span> | The dropoff location. IATA code or a latitude,longitude pair formatted like this: lat,lon-latlong e.g. /55.95,-3.37-latlong/ |
